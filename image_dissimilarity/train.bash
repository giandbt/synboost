...
CUDA_VISIBLE_DEVICES=14 python train.py --config configs/train/baseline_configuration.yaml --gpu_ids 0 --seed 2
CUDA_VISIBLE_DEVICES=14 python train.py --config configs/train/baseline_configuration.yaml --gpu_ids 0 --seed 3
